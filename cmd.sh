...
# ADA
# CUDA_VISIBLE_DEVICES=2 python3 src/main.py -hdf5 -l -t -metrics fid prdc -cfg src/configs/OOD_CelebA/StyleGAN2-ADA_CelebA_test.yaml -data datasets -save results/stylegan2-ada-celeba-test
